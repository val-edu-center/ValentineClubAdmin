...
const ManageAccountPage = ({ courses, authors, actions, history, ...props }) => {
    ...
    return authors.length === 0 || courses.length === 0 ? (<Spinner />) : (<AccountForm course={course} errors={errors} authors={authors} onChange={handleChange} onSave={handleSave} saving={saving}></AccountForm>)
